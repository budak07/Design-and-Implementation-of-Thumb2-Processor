...
HD_PWD='C:/Users/ynsmr/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_cortex_m0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_cortex_m0.tcl
